...
document.getElementById('signup-form').addEventListener('submit', async(e)=>{
    ...
    try{
        ...
        if(response.ok){
            document.getElementById('response-message').innerHTML = result.message || 'Signup successful, please sign in';
        ...
        isSigningUp = false;
        document.getElementById('response-message').innerHTML = 'Error during signup';
    }
});
...
document.getElementById('signin-form').addEventListener('submit', async(e)=>{
    ...
    try{
        ...
        document.getElementById('response-message').innerHTML = 'Error during signin'
    }
});
